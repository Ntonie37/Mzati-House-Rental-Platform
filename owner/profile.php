...
<body>
  							...
  							<ul class="nav navbar-nav navbar-left">
  							 <li><a href="owner-index.php">Home</a></li>
  								...
  								<ul class="nav navbar-nav navbar-right">
  									...
  									<li><a href="owner-login.php">Logout</a></li>
  								</ul>
 ...
 <div class="container-fluid">
  <ul class="nav nav-pills nav-justified">
    <li class="active" style="background-color: #000080"><a data-toggle="pill"> My Profile</a></li>
  </ul>
  ...
  <center> <h1><?php echo $rows['full_name']; ?></h1> <center>
<br><br>  <p class="title"><b>Email : </b><?php echo $rows['email']; ?></p> <br> <br>
  <p><b>Phone No: </b><?php echo $rows['phone_no']; ?></p>  <br> <br>
  <p><b>Address: </b><?php echo $rows['address']; ?></p> <br> <br>
